# XSlim 2.1.2+riscy.2.1: исходники maintenance-версии

Это неофициальный downstream RISCY-SVT на базе исходного кода XSlim 2.1.2.
Публикация исходной ветки отделена от бинарного релиза: нового maintenance-тега,
релиза и загрузки артефактов нет. Установка из точного commit описана в
[INSTALL.md](../../INSTALL.md#source-checkout-and-api-smoke); финальные удалённые
HEAD подтверждаются отдельным receipt MAINT-001-PUB. Опубликованный riscy.2
и замороженные B2/C2 сохранены.
